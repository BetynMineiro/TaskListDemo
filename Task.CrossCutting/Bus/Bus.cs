...
public class Bus(IMediator mediator, ILogger logger) : IBus
{
    ...
    {
        logger.Information("Calling Command Bus | Class: Task.CrossCutting.Bus | Method: SendCommandAsync");
    ...
    {
        logger.Information("Calling Event Bus | Class: Task.CrossCutting.Bus | Method: SendEventAsync");
    ...
    {
        logger.Information("Calling Query Bus | Class: Task.CrossCutting.Bus | Method: SendQueryAsync");
